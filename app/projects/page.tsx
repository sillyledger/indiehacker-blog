...
const projects = [
  {
    name: "Sorano",
    type: "SaaS",
    description: "Social media scheduling Roadmap, changelog and community votes for your product.",
    url: "https://sorano.space",
  },
  {
    name: "Kiroka",
    type: "B2C",
    description: "Tracks your subscriptions and flags renewals before you are charged.",
